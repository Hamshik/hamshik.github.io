...
debfile - program to do something

# SYNOPSIS

**debfile** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**debfile** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **debfile** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**debfile** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    debfile. See **foo.conf**(5) for further details.
...
**debfile** provides some return codes, that can be used in scripts:
...
hamshik suvarna <hamshik.sbv3@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 hamshik suvarna
